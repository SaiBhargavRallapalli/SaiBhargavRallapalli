...
- 🕸️ **Multi-agent orchestration** with LangGraph & AutoGen
- 📐 **Evaluation frameworks** for agentic systems (because vibes aren't a metric)
- ✍️ Writing about it on [Medium](https://saibhargavr.medium.com/) — AI, security, and engineering philosophy
...
<!-- BLOG-POST-LIST:START -->- 🚀 [Google’s Open Knowledge Format &lpar;OKF&rpar;: The Markdown Standard Every AI Engineer Should Know About](https://pub.towardsai.net/googles-open-knowledge-format-okf-the-markdown-standard-every-ai-engineer-should-know-about-1d14b223f39e?source=rss-b6457c7901af------2)- 💡 [Ensemble Learning: Bagging &amp; Random Forest — A Complete Guide](https://blog.gopenai.com/ensemble-learning-bagging-random-forest-a-complete-guide-862d5f336910?source=rss-b6457c7901af------2)- 🚀 [The Algorithm That’s Dumb by Name but Smart by Nature: Naive Bayes](https://pub.towardsai.net/the-algorithm-thats-dumb-by-name-but-smart-by-nature-naive-bayes-d46d201bf66e?source=rss-b6457c7901af------2)- 🚀 [Bagging vs Boosting: The Complete Beginner’s Guide to Ensemble Learning in Machine Learning](https://pub.towardsai.net/bagging-vs-boosting-the-complete-beginners-guide-to-ensemble-learning-in-machine-learning-d0a178387df4?source=rss-b6457c7901af------2)- 💡 [Decision Trees to Bagging: A Beginner’s Complete Guide with Examples](https://blog.gopenai.com/decision-trees-to-bagging-a-beginners-complete-guide-with-examples-bbe368884f4e?source=rss-b6457c7901af------2)<!-- BLOG-POST-LIST:END -->
...
<p align="center">
  <b>Open to collaborating on agentic apps, voice AI, and Node.js / Python backends.</b><br/>
  <sub>Drop a message → <a href="mailto:saibhargavrallapalli@gmail.com">saibhargavrallapalli@gmail.com</a></sub>
</p>
